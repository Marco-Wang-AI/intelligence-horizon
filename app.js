const copy = {
  en: {
    ...
    updateCadence: "Updated every two weeks",
    currentIssueLabel: "Current pulse",
    currentIssueDate: "June 6, 2026",
  ...
  zh: {
    ...
    signalsCta: "看看为什么变了",
    updateCadence: "每两周更新",
    currentIssueLabel: "本期",
    currentIssueDate: "2026 年 6 月 6 日",
    nextIssueLabel: "下期",
